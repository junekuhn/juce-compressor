...
GlobalControls::GlobalControls(juce::AudioProcessorValueTreeState& apvts) {
    ...
    inGainSlider = std::make_unique<RotarySliderWithLabels>(getParamsHelper(Names::Gain_In), "dB");
    lowMidXoverSlider = std::make_unique<RotarySliderWithLabels>(getParamsHelper(Names::Low_Mid_Crossover_Freq), "Hz");
    midHighXoverSlider = std::make_unique<RotarySliderWithLabels>(getParamsHelper(Names::Mid_High_Crossover_Freq), "Hz");
    outGainSlider = std::make_unique<RotarySliderWithLabels>(getParamsHelper(Names::Gain_Out), "dB");
    ...
    addLabelPairs(inGainSlider->labels, getParamsHelper(Names::Gain_In), "dB");
    addLabelPairs(lowMidXoverSlider->labels, getParamsHelper(Names::Low_Mid_Crossover_Freq), "Hz");
    addLabelPairs(midHighXoverSlider->labels, getParamsHelper(Names::Mid_High_Crossover_Freq), "Hz");
    addLabelPairs(outGainSlider->labels, getParamsHelper(Names::Gain_Out), "dB");
